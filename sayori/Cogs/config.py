class conf():
    ...
    cogd = "Cogs"
    type_speed = 2
    playing_msg = [f"Type 'raphiel_help' for help!", "games with Gab", "Minecraft", "Nintendo Switch", "with other angels"]
    ...
    everyone_tag = "Are you som sory of demon, trying to ping everyone?"
