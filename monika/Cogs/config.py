class conf():
    ...
    type_speed = 2
    cooldown_timer = 1.5
    playing_msg = ["Type 'gab_help' for help!", "League of Legends", "Minecraft", "Nintendo Switch", "on her laptop", "a computer games", "games with Vigne", "from your computer!", "Kirby"]
    ...
    norm = 0xff3d34 # The Normal or Yeah sure i did this command heres an embed color Embed Colour
